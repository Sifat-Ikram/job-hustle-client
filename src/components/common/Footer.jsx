...
const Footer = () => {
    return (
        <div>
            <footer className="footer footer-center p-10 bg-[#06D6C6] text-primary-content rounded-md">
                <aside>
                    <h1 className="font-bold text-7xl font-joseph"><span className='text-white'>Job</span><span className='text-warning'>Hustle</span></h1>
                </aside>
